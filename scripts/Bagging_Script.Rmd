...
#Split 1 dataset 
python_df = read.csv("C:/Users/jacob.derosa/Desktop/Scripts/Full_CBCL_Splits/All_CBCL_Splits/CBCL_Split_1.csv", header = T, sep = ",") %>% select(X) %>% rename(Key = X)
...
stab_full_split_1 = adj_full_1/100
...
stab_full_split_2 = adj_full_1/100
