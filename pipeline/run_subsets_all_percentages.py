...
def run_subsets_all_percentages(input_data_path, n_subsets, n_boots, mri, n_cpus, output_dir):
	...
	for pct in [10,20,30,40,50,60,70,80,90]:
		os.system(f'python run_louvain_subsets.py {input_data_path} {pct} {n_subsets} {n_boots} {n_cpus} False {output_dir}')

	# Full dataset
	os.system(f'python run_louvain_subsets.py {input_data_path} 100 1 1 1 False {output_dir}')
